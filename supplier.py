...
#==================================================================================
    ...
    def add(self):
        ...
        try:
            if self.var_sup_invoice.get()=="":
                messagebox.showerror("Error","Invoice ID you need must enter",parent=root)  
                
            else:
                cur.execute("Select * from supplier where invoice=?",(self.var_sup_invoice.get(),))    
                row=cur.fetchone()
                if row!=None:
                    messagebox.showerror("Error","Invoice no. alredy assinged, try different",parent=self.root)    
                else:
    ...
    def update(self):
        ...
        try:
            if self.var_sup_invoice.get()=="":
                messagebox.showerror("Error","Invoice no. Must be requried",parent=root)  
    ...
    def delete(self):
        ...
        try:
            if self.var_sup_invoice.get()=="":
                messagebox.showerror("Error","Invoice no.must be enter",parent=root)  
    ...
    def search(self):
            ...
            try:
                if self.var_searchtxt.get()=="":
                    messagebox.showerror("Error","Inoive no. should be requried",parent=self.root)
